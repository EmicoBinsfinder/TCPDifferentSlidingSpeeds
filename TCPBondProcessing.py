...
Speeds = ['1ms', '20ms', '40ms', '50ms']
Temperatures = ["400K"]
Pressures = ["1GPa", "2GPa", "3GPa", "4GPa", "5GPa"]
for S in Speeds:
    for T in Temperatures:
        for P in Pressures:
            print("D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/".format(S, T, P))
            # sys.path.append("/home/carlos/anaconda3/lib/python3.7/site-packages")
            sys.path.append(
                "D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/".format(S, T,
                                                                                                                 P))
            import numpy as np
            ...
            if __name__ == "__main__":
                ...
                dir = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/'.format(S, T,
                                                                                                             P)  # CHANGEHERE
                directories = [dir]
                ...
                for border in borders:
                    for ind, direct in enumerate(directories):
                        ...
                        datafile = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/48_TCP_Fe.data'.format(
                            S, T, P)  # CHANGEHERE
                        starting_bfile = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/48_TCP_Fe-BONDS.data'.format(
                            S, T, P)  # CHANGEHERE

                        start = time.time()
                        tal = Networkgen(datafile, starting_bfile)
                        tal.ovito_mols(
                            fout='D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/'.format(
                                S, T, P) + system + '_ovitoMols')  # CHANGEHERE
                        tinit = time.time()
                        ...
                        # fout_CH='D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/'.format(S, T, P)+system+'C_2-H_1'+str(border)
                        ...
                        fout = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/'.format(
                            S, T, P) + system + '_b' + str(  # CHANGEHERE
                            border)
                        fout_new = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/'.format(
                            S, T, P) + system + '_new_b' + str(  # CHANGEHERE
                            border)
                        fout_start = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/'.format(
                            S, T, P) + system + '_start_b' + str(  # CHANGEHERE
                            border)
                        ...
                        path_name_data_out = "D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/ovito_datafiles/".format(
                            S, T, P) + system + '_'  # CHANGEHERE

                        datafile_for_header = '48_TCP_Fe.data'
                        ...
                        fout_intact = 'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/'.format(
                            S, T, P) + system + '_IntactMols_' + str(  # CHANGEHERE
                            border)
            ...
            MoleculesIntact = pd.read_csv(
                'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/Fe2O3-200-iso-octane_IntactMols_0.3'.format(
                    S, T, P),
                sep='\t')
            """
            ...
            MoleculesIntact.to_excel(
                'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/Intact.xlsx'.format(
                    S, T, P),
                'Sheet 1', index=False)
            """
            ...
            plt.savefig(
                'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/Intact.png'.format(
                    S, T, P))
            ...
            NewMolecules = pd.read_csv(
                'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/Fe2O3-200-iso-octane_b0.3'.format(
                    S, T, P), sep='\t')
            """
            ...
            NewMolecules.to_excel(
                'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/NewMolecules.xlsx'.format(
                    S, T, P),
                'Sheet 1', index=False)
            """
            The above code is what translates from a text file to an excel file:
            ...
            while Index < NumberofBondTypes:
                ...
                plt.savefig(
                    'D:/PhD/TCPDecompositionExperiments/Completed/DifferentSlidingSpeeds/{}/{}/{}/processed/'.format(S,
                                                                                                                     T,
                                                                                                                     P) + GRAPHNAME + '.png')
                # plt.show()
                Index += 1
